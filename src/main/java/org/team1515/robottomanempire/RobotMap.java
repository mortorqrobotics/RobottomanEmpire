...
public class RobotMap {
	...
	public static final int[] TOP_SHOOTER_TALON_IDS = {};
	public static final int[] BOTTOM_SHOOTER_TALON_IDS = {};
	...
	public static final double SHOOTER_WHEEL_DIAMETER = 4.0/12;
	...
	public static final Triple<Double> ARM_PID_CONSTANTS = new Triple<Double>(1.0, 0.01, 0.0);
